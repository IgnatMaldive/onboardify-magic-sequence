...
const ProfileSetup = () => {
  ...
  const { username, setUsername, profileDescription, setProfileDescription } = useUser();
      ...
      <div className="min-h-screen flex items-center justify-center p-5">
        ...
        >
          <div className="bg-card border border-border rounded-lg shadow-lg overflow-hidden">
            <div className="h-40 bg-gradient-to-r from-primary/10 to-accent/10 flex items-center justify-center relative overflow-hidden">
              <motion.div
            ...
            <div className="p-8 pt-14 relative">
              <motion.div 
                className="absolute -top-10 left-8 w-20 h-20 rounded-full bg-primary/20 border-4 border-card"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
              ...
              >
                ...
                <div className="flex items-center justify-end space-x-4">
                  ...
                  <motion.button
                    onClick={handleSave}
                    className="px-5 py-2 bg-primary text-primary-foreground font-semibold rounded-md text-sm transition-all hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:opacity-70 flex items-center justify-center"
